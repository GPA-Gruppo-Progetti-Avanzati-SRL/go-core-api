...
require (
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/go-core-app v0.0.0-20241202082728-182ebe5aae28
...
require (
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-common v0.1.67 // indirect
