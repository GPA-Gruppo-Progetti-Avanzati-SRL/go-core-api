...
require (
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/go-core-app v0.0.4-0.20250410092020-fc4f1a9c86e3
...
require (
	github.com/GPA-Gruppo-Progetti-Avanzati-SRL/tpm-common v0.1.79 // indirect
